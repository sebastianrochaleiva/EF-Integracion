...
const { addMesero, getAllMeseros, updateMesero, deleteMesero, login, getMesero } = require('../controllers/meseroC');

const router = express.Router();

router.post("/api/mesero", addMesero); // Crear mesero
router.get("/api/meseros", getAllMeseros); // Obtener todos los meseros
router.get("/api/mesero/:id", getMesero); // Obtener todos los meseros
